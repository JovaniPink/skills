...
The engineering plugin is cleared for both command lines as of 2026-09-10. Other app modes remain unchecked. Read the [current candidate checks](client-candidate-v0.14.0.md) before you rely on one.
