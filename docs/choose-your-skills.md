...
The engineering plugin is held on the Codex and Claude Code command lines. A live motion review failed there. Read the [current candidate checks](client-candidate-v0.14.0.md) before you enable it.
