...
Read the [skill catalog reader guide](skill-catalog-reader-guide.md) for the complete 61-skill inventory, verified plugin grouping, explicit-only map, and client-specific selection boundaries.
