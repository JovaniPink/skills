...
6. Record Desktop, web, API, and command-line observations separately. Historical blocked records remain historical. For v0.9, create a terminal row only after it can be recorded as `pass`, `fail`, or genuinely `not_supported`; do not use a placeholder row to imply acceptance.
