...
The [current candidate record](client-candidate-v0.16.0.md) lists install results and active holds. A prepared package is not a recommendation to enable it before its checks pass.
